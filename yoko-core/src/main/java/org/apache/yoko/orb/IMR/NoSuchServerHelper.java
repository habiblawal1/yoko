...
//
final public class NoSuchServerHelper
{
    public static void
    insert(org.omg.CORBA.Any any, NoSuchServer val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_exception_tc(id(), "NoSuchServer", members);
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/IMR/NoSuchServer:1.0";
    }
    ...
    public static void
    write(org.omg.CORBA.portable.OutputStream out, NoSuchServer val)
    {
        out.write_string(id());

...
//
final public class DispatchRequestHelper
{
    public static void
    insert(org.omg.CORBA.Any any, DispatchRequest val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = ((org.omg.CORBA_2_4.ORB)orb).create_local_interface_tc(id(), "DispatchRequest");
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OB/DispatchRequest:1.0";
    }

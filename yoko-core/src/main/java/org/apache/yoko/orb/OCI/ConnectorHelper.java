...
//
final public class ConnectorHelper
{
    public static void
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = ((org.omg.CORBA_2_4.ORB)orb).create_local_interface_tc(id(), "Connector");
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OCI/Connector:1.0";
    }

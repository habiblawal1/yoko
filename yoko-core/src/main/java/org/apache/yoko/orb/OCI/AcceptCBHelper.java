...
//
final public class AcceptCBHelper
{
    public static void
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = ((org.omg.CORBA_2_4.ORB)orb).create_local_interface_tc(id(), "AcceptCB");
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OCI/AcceptCB:1.0";
    }

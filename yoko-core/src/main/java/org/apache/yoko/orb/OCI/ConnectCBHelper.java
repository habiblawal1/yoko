...
//
final public class ConnectCBHelper
{
    public static void
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = ((org.omg.CORBA_2_4.ORB)orb).create_local_interface_tc(id(), "ConnectCB");
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OCI/ConnectCB:1.0";
    }

...
//
final public class ORBInitInfoHelper
{
    public static void
    insert(org.omg.CORBA.Any any, ORBInitInfo val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = ((org.omg.CORBA_2_4.ORB)orb).create_local_interface_tc(id(), "ORBInitInfo");
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OBPortableInterceptor/ORBInitInfo:1.0";
    }

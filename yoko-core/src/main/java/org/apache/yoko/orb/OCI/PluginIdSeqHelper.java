...
//
final public class PluginIdSeqHelper
{
    public static void
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_alias_tc(id(), "PluginIdSeq", orb.create_sequence_tc(0, PluginIdHelper.type()));
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OCI/PluginIdSeq:1.0";
    }

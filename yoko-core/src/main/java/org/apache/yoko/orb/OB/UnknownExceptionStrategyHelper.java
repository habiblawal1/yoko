...
//
final public class UnknownExceptionStrategyHelper
{
    public static void
    insert(org.omg.CORBA.Any any, UnknownExceptionStrategy val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = ((org.omg.CORBA_2_4.ORB)orb).create_local_interface_tc(id(), "UnknownExceptionStrategy");
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OB/UnknownExceptionStrategy:1.0";
    }
    ...
    narrow(org.omg.CORBA.Object val)
    {
        try
        {
            return (UnknownExceptionStrategy)val;
        }

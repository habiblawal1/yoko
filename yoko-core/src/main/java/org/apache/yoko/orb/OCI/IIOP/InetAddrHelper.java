...
//
// IDL:orb.yoko.apache.org/OCI/IIOP/InetAddr:1.0
//
final public class InetAddrHelper
{
    public static void
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_alias_tc(id(), "InetAddr", orb.get_primitive_tc(org.omg.CORBA.TCKind.tk_string));
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OCI/IIOP/InetAddr:1.0";
    }

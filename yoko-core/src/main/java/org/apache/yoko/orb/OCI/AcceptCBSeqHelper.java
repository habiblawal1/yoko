...
//
// IDL:orb.yoko.apache.org/OCI/AcceptCBSeq:1.0
//
final public class AcceptCBSeqHelper
{
    public static void
    insert(org.omg.CORBA.Any any, AcceptCB[] val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_alias_tc(id(), "AcceptCBSeq", orb.create_sequence_tc(0, AcceptCBHelper.type()));
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OCI/AcceptCBSeq:1.0";
    }

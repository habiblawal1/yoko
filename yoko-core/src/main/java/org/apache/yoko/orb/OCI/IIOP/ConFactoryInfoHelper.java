...
//
final public class ConFactoryInfoHelper
{
    public static void
    insert(org.omg.CORBA.Any any, ConFactoryInfo val)
    {
        any.insert_Object(val, type());
    }

    public static ConFactoryInfo
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = ((org.omg.CORBA_2_4.ORB)orb).create_local_interface_tc(id(), "ConFactoryInfo");
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OCI/IIOP/ConFactoryInfo:1.0";
    }
    ...
    public static void
    write(org.omg.CORBA.portable.OutputStream out, ConFactoryInfo val)
    {
        throw new org.omg.CORBA.MARSHAL(
                MinorCodes

...
//
final public class DispatchStrategyHelper
{
    public static void
    insert(org.omg.CORBA.Any any, DispatchStrategy val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = ((org.omg.CORBA_2_4.ORB)orb).create_local_interface_tc(id(), "DispatchStrategy");
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OB/DispatchStrategy:1.0";
    }

...
//
final public class PluginHelper
{
    public static void
    insert(org.omg.CORBA.Any any, Plugin val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = ((org.omg.CORBA_2_4.ORB)orb).create_local_interface_tc(id(), "Plugin");
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OCI/Plugin:1.0";
    }
    ...
    public static void
    write(org.omg.CORBA.portable.OutputStream out, Plugin val)
    {
        throw new org.omg.CORBA.MARSHAL(
                MinorCodes

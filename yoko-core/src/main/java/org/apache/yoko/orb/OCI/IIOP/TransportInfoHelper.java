...
//
final public class TransportInfoHelper
{
    public static void
    insert(org.omg.CORBA.Any any, TransportInfo val)
    {
        any.insert_Object(val, type());
    }

    public static TransportInfo
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = ((org.omg.CORBA_2_4.ORB)orb).create_local_interface_tc(id(), "TransportInfo");
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OCI/IIOP/TransportInfo:1.0";
    }
    ...
    public static void
    write(org.omg.CORBA.portable.OutputStream out, TransportInfo val)
    {
        throw new org.omg.CORBA.MARSHAL(
                MinorCodes

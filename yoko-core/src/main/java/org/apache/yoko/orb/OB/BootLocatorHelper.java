...
//
final public class BootLocatorHelper
{
    public static void
    insert(org.omg.CORBA.Any any, BootLocator val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = ((org.omg.CORBA_2_4.ORB)orb).create_local_interface_tc(id(), "BootLocator");
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OB/BootLocator:1.0";
    }

...
//
final public class AcceptorInfoHelper
{
    public static void
    insert(org.omg.CORBA.Any any, AcceptorInfo val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = ((org.omg.CORBA_2_4.ORB)orb).create_local_interface_tc(id(), "AcceptorInfo");
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OCI/IIOP/AcceptorInfo:1.0";
    }

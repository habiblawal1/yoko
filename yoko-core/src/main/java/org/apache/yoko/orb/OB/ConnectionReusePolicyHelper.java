...
//
final public class ConnectionReusePolicyHelper
{
    public static void
    insert(org.omg.CORBA.Any any, ConnectionReusePolicy val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = ((org.omg.CORBA_2_4.ORB)orb).create_local_interface_tc(id(), "ConnectionReusePolicy");
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OB/ConnectionReusePolicy:1.0";
    }
    ...
    narrow(org.omg.CORBA.Object val)
    {
        try
        {
            return (ConnectionReusePolicy)val;
        }

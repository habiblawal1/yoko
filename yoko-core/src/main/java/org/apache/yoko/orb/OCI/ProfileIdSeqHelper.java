...
//
final public class ProfileIdSeqHelper
{
    public static void
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_alias_tc(id(), "ProfileIdSeq", orb.create_sequence_tc(0, ProfileIdHelper.type()));
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OCI/ProfileIdSeq:1.0";
    }

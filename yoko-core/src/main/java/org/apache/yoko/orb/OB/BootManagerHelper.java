...
//
final public class BootManagerHelper
{
    public static void
    insert(org.omg.CORBA.Any any, BootManager val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = ((org.omg.CORBA_2_4.ORB)orb).create_local_interface_tc(id(), "BootManager");
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OB/BootManager:1.0";
    }

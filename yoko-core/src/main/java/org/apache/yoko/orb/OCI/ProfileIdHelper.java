...
//
final public class ProfileIdHelper
{
    public static void
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_alias_tc(id(), "ProfileId", org.omg.IOP.ProfileIdHelper.type());
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OCI/ProfileId:1.0";
    }
    ...
    {
        int _ob_v;
        _ob_v = org.omg.IOP.ProfileIdHelper.read(in);
        return _ob_v;
    }
    ...
    {
        org.omg.IOP.ProfileIdHelper.write(out, val);
    }
}

...
//
final public class OADRunningHelper
{
    public static void
    insert(org.omg.CORBA.Any any, OADRunning val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_exception_tc(id(), "OADRunning", members);
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/IMR/OADRunning:1.0";
    }
    ...
    public static void
    write(org.omg.CORBA.portable.OutputStream out, OADRunning val)
    {
        out.write_string(id());

...
//
final public class RequestTimeoutPolicyHelper
{
    public static void
    insert(org.omg.CORBA.Any any, RequestTimeoutPolicy val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = ((org.omg.CORBA_2_4.ORB)orb).create_local_interface_tc(id(), "RequestTimeoutPolicy");
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OB/RequestTimeoutPolicy:1.0";
    }
    ...
    narrow(org.omg.CORBA.Object val)
    {
        try
        {
            return (RequestTimeoutPolicy)val;
        }

...
//
final public class AccFactorySeqHelper
{
    public static void
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_alias_tc(id(), "AccFactorySeq", orb.create_sequence_tc(0, AccFactoryHelper.type()));
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OCI/AccFactorySeq:1.0";
    }

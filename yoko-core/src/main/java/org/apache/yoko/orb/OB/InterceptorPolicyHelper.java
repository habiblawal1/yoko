...
//
final public class InterceptorPolicyHelper
{
    public static void
    insert(org.omg.CORBA.Any any, InterceptorPolicy val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = ((org.omg.CORBA_2_4.ORB)orb).create_local_interface_tc(id(), "InterceptorPolicy");
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OB/InterceptorPolicy:1.0";
    }

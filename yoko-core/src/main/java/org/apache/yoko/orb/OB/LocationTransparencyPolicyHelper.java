...
//
final public class LocationTransparencyPolicyHelper
{
    public static void
    insert(org.omg.CORBA.Any any, LocationTransparencyPolicy val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = ((org.omg.CORBA_2_4.ORB)orb).create_local_interface_tc(id(), "LocationTransparencyPolicy");
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OB/LocationTransparencyPolicy:1.0";
    }
    ...
    narrow(org.omg.CORBA.Object val)
    {
        try
        {
            return (LocationTransparencyPolicy)val;
        }

...
//
final public class ServerAlreadyRegisteredHelper
{
    public static void
    insert(org.omg.CORBA.Any any, ServerAlreadyRegistered val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_exception_tc(id(), "ServerAlreadyRegistered", members);
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/IMR/ServerAlreadyRegistered:1.0";
    }
    ...
    public static void
    write(org.omg.CORBA.portable.OutputStream out, ServerAlreadyRegistered val)
    {
        out.write_string(id());

...
//
// IDL:orb.yoko.apache.org/OCI/Originator:1.0
//
final public class OriginatorHelper
{
    public static void
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_alias_tc(id(), "Originator", orb.get_primitive_tc(org.omg.CORBA.TCKind.tk_ushort));
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OCI/Originator:1.0";
    }

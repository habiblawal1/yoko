...
//
final public class ConFactoryRegistryHelper
{
    public static void
    insert(org.omg.CORBA.Any any, ConFactoryRegistry val)
    {
        any.insert_Object(val, type());
    }

    public static ConFactoryRegistry
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = ((org.omg.CORBA_2_4.ORB)orb).create_local_interface_tc(id(), "ConFactoryRegistry");
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OCI/ConFactoryRegistry:1.0";
    }
    ...
    public static void
    write(org.omg.CORBA.portable.OutputStream out, ConFactoryRegistry val)
    {
        throw new org.omg.CORBA.MARSHAL(
                MinorCodes

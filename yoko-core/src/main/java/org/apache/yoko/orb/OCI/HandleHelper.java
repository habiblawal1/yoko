...
//
// IDL:orb.yoko.apache.org/OCI/Handle:1.0
//
final public class HandleHelper
{
    public static void
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_alias_tc(id(), "Handle", orb.get_primitive_tc(org.omg.CORBA.TCKind.tk_long));
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OCI/Handle:1.0";
    }

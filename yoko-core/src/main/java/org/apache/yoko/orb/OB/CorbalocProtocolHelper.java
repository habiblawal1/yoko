...
//
final public class CorbalocProtocolHelper
{
    public static void
    insert(org.omg.CORBA.Any any, CorbalocProtocol val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = ((org.omg.CORBA_2_4.ORB)orb).create_local_interface_tc(id(), "CorbalocProtocol");
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OB/CorbalocProtocol:1.0";
    }

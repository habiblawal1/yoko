...
//
final public class URLSchemeHelper
{
    public static void
    insert(org.omg.CORBA.Any any, URLScheme val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = ((org.omg.CORBA_2_4.ORB)orb).create_local_interface_tc(id(), "URLScheme");
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OB/URLScheme:1.0";
    }

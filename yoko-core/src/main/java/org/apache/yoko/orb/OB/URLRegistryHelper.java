...
//
final public class URLRegistryHelper
{
    public static void
    insert(org.omg.CORBA.Any any, URLRegistry val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = ((org.omg.CORBA_2_4.ORB)orb).create_local_interface_tc(id(), "URLRegistry");
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OB/URLRegistry:1.0";
    }

...
//
final public class PersistentORTHolder implements org.omg.CORBA.portable.Streamable
{
    public PersistentORT value;
    ...
    {
        value = PersistentORTHelper.read(in);
    }

    public void
    _write(org.omg.CORBA.portable.OutputStream out)
    {
        PersistentORTHelper.write(out, value);
    }

...
//
// IDL:orb.yoko.apache.org/OCI/ParamSeq:1.0
//
final public class ParamSeqHelper
{
    public static void
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_alias_tc(id(), "ParamSeq", orb.create_sequence_tc(0, orb.get_primitive_tc(org.omg.CORBA.TCKind.tk_string)));
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OCI/ParamSeq:1.0";
    }

...
//
final public class InvalidParamHelper
{
    public static void
    insert(org.omg.CORBA.Any any, InvalidParam val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_exception_tc(id(), "InvalidParam", members);
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OCI/InvalidParam:1.0";
    }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        InvalidParam _ob_v = new InvalidParam();
        _ob_v.reason = in.read_string();
        return _ob_v;
    }

    public static void
    write(org.omg.CORBA.portable.OutputStream out, InvalidParam val)
    {
        out.write_string(id());

...
//
final public class ServerRunningHelper
{
    public static void
    insert(org.omg.CORBA.Any any, ServerRunning val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_exception_tc(id(), "ServerRunning", members);
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/IMR/ServerRunning:1.0";
    }
    ...
    public static void
    write(org.omg.CORBA.portable.OutputStream out, ServerRunning val)
    {
        out.write_string(id());

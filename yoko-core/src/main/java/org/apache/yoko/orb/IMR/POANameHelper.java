...
//
// IDL:orb.yoko.apache.org/IMR/POAName:1.0
//
final public class POANameHelper
{
    public static void
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_alias_tc(id(), "POAName", org.omg.CORBA.StringSeqHelper.type());
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/IMR/POAName:1.0";
    }

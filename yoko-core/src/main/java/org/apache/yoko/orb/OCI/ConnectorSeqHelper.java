...
//
final public class ConnectorSeqHelper
{
    public static void
    insert(org.omg.CORBA.Any any, Connector[] val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_alias_tc(id(), "ConnectorSeq", orb.create_sequence_tc(0, ConnectorHelper.type()));
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OCI/ConnectorSeq:1.0";
    }
    ...
    public static void
    write(org.omg.CORBA.portable.OutputStream out, Connector[] val)
    {
        throw new org.omg.CORBA.MARSHAL(
                MinorCodes

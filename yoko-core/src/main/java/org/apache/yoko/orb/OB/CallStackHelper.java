...
//
// IDL:orb.yoko.apache.org/OB/CallStack:1.0
//
final public class CallStackHelper
{
    public static void
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_alias_tc(id(), "CallStack", orb.create_sequence_tc(0, orb.get_primitive_tc(org.omg.CORBA.TCKind.tk_string)));
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OB/CallStack:1.0";
    }

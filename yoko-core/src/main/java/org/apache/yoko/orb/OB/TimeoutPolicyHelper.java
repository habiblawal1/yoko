...
//
final public class TimeoutPolicyHelper
{
    public static void
    insert(org.omg.CORBA.Any any, TimeoutPolicy val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = ((org.omg.CORBA_2_4.ORB)orb).create_local_interface_tc(id(), "TimeoutPolicy");
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OB/TimeoutPolicy:1.0";
    }

...
//
final public class AcceptorSeqHelper
{
    public static void
    insert(org.omg.CORBA.Any any, Acceptor[] val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_alias_tc(id(), "AcceptorSeq", orb.create_sequence_tc(0, AcceptorHelper.type()));
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OCI/AcceptorSeq:1.0";
    }

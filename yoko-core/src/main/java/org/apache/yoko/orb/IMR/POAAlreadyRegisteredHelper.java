...
//
final public class POAAlreadyRegisteredHelper
{
    public static void
    insert(org.omg.CORBA.Any any, POAAlreadyRegistered val)
    {
    ...
    public static void
    write(org.omg.CORBA.portable.OutputStream out, POAAlreadyRegistered val)
    {
        out.write_string(id());

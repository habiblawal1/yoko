...
//
final public class TransportHelper
{
    public static void
    insert(org.omg.CORBA.Any any, Transport val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = ((org.omg.CORBA_2_4.ORB)orb).create_local_interface_tc(id(), "Transport");
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OCI/Transport:1.0";
    }
    ...
    public static void
    write(org.omg.CORBA.portable.OutputStream out, Transport val)
    {
        throw new org.omg.CORBA.MARSHAL(
                MinorCodes

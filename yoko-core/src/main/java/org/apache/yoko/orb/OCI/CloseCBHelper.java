...
//
final public class CloseCBHelper
{
    public static void
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = ((org.omg.CORBA_2_4.ORB)orb).create_local_interface_tc(id(), "CloseCB");
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OCI/CloseCB:1.0";
    }

...
//
final public class ConnectTimeoutPolicyHelper
{
    public static void
    insert(org.omg.CORBA.Any any, ConnectTimeoutPolicy val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = ((org.omg.CORBA_2_4.ORB)orb).create_local_interface_tc(id(), "ConnectTimeoutPolicy");
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OB/ConnectTimeoutPolicy:1.0";
    }
    ...
    narrow(org.omg.CORBA.Object val)
    {
        try
        {
            return (ConnectTimeoutPolicy)val;
        }

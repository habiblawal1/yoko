...
//
final public class AcceptorHelper
{
    public static void
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = ((org.omg.CORBA_2_4.ORB)orb).create_local_interface_tc(id(), "Acceptor");
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OCI/Acceptor:1.0";
    }

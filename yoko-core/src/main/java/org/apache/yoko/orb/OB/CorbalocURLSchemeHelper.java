...
//
final public class CorbalocURLSchemeHelper
{
    public static void
    insert(org.omg.CORBA.Any any, CorbalocURLScheme val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = ((org.omg.CORBA_2_4.ORB)orb).create_local_interface_tc(id(), "CorbalocURLScheme");
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OB/CorbalocURLScheme:1.0";
    }

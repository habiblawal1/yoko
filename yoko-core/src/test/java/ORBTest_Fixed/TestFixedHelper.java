...
//
// IDL:ORBTest_Fixed/TestFixed:1.0
//
final public class TestFixedHelper
{
    public static void
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_alias_tc(id(), "TestFixed", orb.create_fixed_tc((short)24, (short)8));
        }
    ...
    id()
    {
        return "IDL:ORBTest_Fixed/TestFixed:1.0";
    }

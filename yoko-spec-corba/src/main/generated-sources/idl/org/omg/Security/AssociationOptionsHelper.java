...
/**
* org/omg/Security/AssociationOptionsHelper.java .
...
{
  private static String  _id = "IDL:omg.org/Security/AssociationOptions:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (org.omg.Security.AssociationOptionsHelper.id (), "AssociationOptions", __typeCode);
    }
    return __typeCode;
  }

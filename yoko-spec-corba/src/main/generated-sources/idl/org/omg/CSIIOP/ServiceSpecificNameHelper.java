...
/**
* org/omg/CSIIOP/ServiceSpecificNameHelper.java .
* Error reading Messages File.
* Error reading Messages File.
* Thursday, January 14, 2010 1:08:59 AM PST
*/

abstract public class ServiceSpecificNameHelper
{
  private static String  _id = "IDL:omg.org/CSIIOP/ServiceSpecificName:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (org.omg.CSIIOP.ServiceSpecificNameHelper.id (), "ServiceSpecificName", __typeCode);
    }
    return __typeCode;
  }

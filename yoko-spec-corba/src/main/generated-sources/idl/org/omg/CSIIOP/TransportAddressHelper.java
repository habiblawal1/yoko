...
/**
* org/omg/CSIIOP/TransportAddressHelper.java .
...
abstract public class TransportAddressHelper
{
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[1] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (org.omg.CSIIOP.TransportAddressHelper.id (), "TransportAddress", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    org.omg.CSIIOP.TransportAddress value = new org.omg.CSIIOP.TransportAddress ();
    value.host_name = istream.read_string ();

...
/**
* org/omg/CosTransactions/TransactionPolicyValueHelper.java .
* Error reading Messages File.
* Error reading Messages File.
* Thursday, January 14, 2010 1:08:59 AM PST
*/

abstract public class TransactionPolicyValueHelper
{
  private static String  _id = "IDL:CosTransactions/TransactionPolicyValue:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (org.omg.CosTransactions.TransactionPolicyValueHelper.id (), "TransactionPolicyValue", __typeCode);
    }
    return __typeCode;
  }
